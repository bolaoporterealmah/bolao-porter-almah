SPA.pages["palpites"]={style:`.phase-section { margin-bottom: 28px; }
.phase-header {
...
(function(){
  ...
  render();
  if (window.syncBetsFromSupabase) window.syncBetsFromSupabase().then(function(){ if(SPA.current==='palpites') render(); });
})();
